...
public class Jugador implements Serializable {
    ...
    public void setPlantado(boolean s) {
        plantado = s;
    }
    ...
    public void setCongelado(boolean f) {
        congelado = f;
        if (f) {
            // Un jugador congelado también queda plantado
            plantado = true;
        }
    }
    ...
    public int getCantidadCartasNumero() {
        return cartasNumero.size();
    }

    public List<Carta> getCartasNumero() {
        return cartasNumero;
    }

    public List<Carta> getCartasModificador() {
        return cartasModificador;
    }

    public List<Carta> getCartasAccion() {
        return cartasAccion;
    }
    ...
    public void agregarAPuntajeTotal(int p) {
        puntajeTotal += p;
    }
